    ...
    var Swiper = function (container, params) {
        ...
        s.updateAutoHeight = function() {
            ...
            if ("auto" !== s.params.slidesPerView && s.params.slidesPerView > 1)
                for (var r = 0; r < Math.ceil(s.params.slidesPerView); r++) {
            ...
            for (var r = 0; r < e.length; r++)
                if ("undefined" != typeof e[r]) {
                    //var h = e[r].offsetHeight;
                    var h = $(e[r]).attr('data-height');
                    a = h > a ? h : a;
                }
        ...
        s.slideTo = function (slideIndex, speed, runCallbacks, internal) {
            ...
            s.container.attr('data-initial-slide',s.activeIndex);
        ...
        s.lazy = {
            ...
            loadImageInSlide: function (index) {
                ...
                img.each(function () {
                    ...
                    s.loadImage(_img[0], src, false, function () {
                        ...
                        _img.addClass('swiper-lazy-loaded').removeClass('swiper-lazy-loading').error(function (e) {
                            _img.addClass('swiper-lazy-error').attr('src', MY_SERVER['PUBLIC'] + '/images/public/blank.png');
                        });
            ...
            load: function () {
                ...
                if (s.params.lazyLoadingInPrevNext) {
                    var activeSlide = s.wrapper.children('.' + s.params.slideActiveClass);
                    if(s.params.lazyLoadingInPrevNextAmount) {
                        var nextSlide = activeSlide;
                        var prevSlide = activeSlide;
                        for (var i=1; i <= s.params.lazyLoadingInPrevNextAmount; ++i) {
                        ...
                        s.lazy.loadImageInSlide(activeSlide.next().index());
                        s.lazy.loadImageInSlide(activeSlide.prev().index());
                    }
                }
            },
        ...
        defaults: {
            ...
            onClick: function (swiper, e) {
                try {
                    ...
                    var func = eval('spc_'+page.attr('id')+'_'+swiper.params.id);
                    if (typeof func === 'function'){
                        func.call(this, swiper, e, page);
                    }
                } catch(ev) {}
            },
            ...
            //    try {
            //        var page = $.custom.pageObj;
            //        var func = eval('spce_'+page.attr('id')+'_'+swiper.params.id);
            //        if (typeof func === 'function'){
            //            func.call(this, swiper, page);
            ...
            onTouchEnd: function (swiper,e) {
                ...
                var inner_scroll = slide.find('.inner-scroll');
                if(inner_scroll.length > 0) {
                    inner_scroll.attr('data-scroll',inner_scroll.scrollTop());
                }

                //try {
                //    var page = $.custom.pageObj;
                //    var func = eval('spte_'+page.attr('id')+'_'+swiper.params.id);
                //    if (typeof func === 'function'){
                //        func.call(this, swiper, e, page);
                //        $.toggleCurInnerScroll(page);
                //        $.toggleFixedTop();
            ...
            onTransitionEnd: function (swiper) {
                ...
                var inner_scroll = slide.find('.inner-scroll');
                if(inner_scroll.length > 0) {
                    var scroll_top = parseFloat(inner_scroll.attr('data-scroll'));
                    inner_scroll.scrollTop(scroll_top);
                    $.custom.cur_inner_scroll = inner_scroll;
                }

                try {
                    var page = $.custom.pageObj;
                    var func = eval('sptre_'+page.attr('id')+'_'+swiper.params.id);
                    if (typeof func === 'function'){
                        setTimeout(function() {
                            func.call(this, swiper, page);
                            $.toggleCurInnerScroll(page);
...
+function($){
    ...
    var PhotoBrowser = function (params) {
        ...
        var tallyTemplate = pb.params.tallyTemplate ||  '<div class="photo-browser-tally"><div class="photo-browser-tally-content"><span class="photo-browser-current"></span>&nbsp;&frasl;&nbsp;<span class="photo-browser-total"></span></div></div>';
        ...
        var htmlTemplate = template
            ...
            .replace('{{tally}}', tallyTemplate.replace(/{{tally}}/g, tallyHtml));
        ...
        pb.layout = function (index) {
            ...
            pb.tallyContainer = pb.container.find('.photo-browser-tally');

            var swiperBottom = ((getScreenHeight()-getScreenWidth())/2);
            pb.captionsContainer.css('bottom', (swiperBottom*2/3)+'px');
            pb.tallyContainer.css('bottom', (swiperBottom/3)+'px');
